...
const testimonials = [
  {
    ...
    company: "科技公司",
    testimonial:
      "这个模板的设计非常简洁优雅，完全符合现代网站的设计趋势。 " +
      "使用起来非常方便，让我能够快速构建出专业的落地页。",
  ...
  },
  {
    ...
    company: "创新科技",
    testimonial:
      "作为一个产品经理，我非常喜欢这个模板的模块化设计。 " +
      "组件丰富且易于定制，能够满足各种业务场景的需求。",
  ...
  },
  {
    ...
    company: "设计工作室",
    testimonial:
      "模板的视觉设计非常出色，配色方案专业且协调。 " +
      "响应式设计让页面在各种设备上都能完美展示。",
  ...
  },
  {
    ...
    company: "软件开发",
    testimonial:
      "代码结构清晰，注释完善，让我能够快速理解和修改。 " +
      "性能优化做得很好，页面加载速度快，用户体验佳。",
  ...
  },
  {
    ...
    company: "互联网公司",
    testimonial:
      "这是一个非常实用的模板，特别适合快速开发落地页。 " +
      "主题定制功能强大，能够轻松打造独特的品牌风格。",
